...
<head>
    ...
    />
    <link rel="stylesheet" href="css/borrowRequest.css">
</head>
<body>
    <div class="heading">
    ...
    <div class="container">
        ...
        <div class="borrowTable">
                    ...
                    <tbody>
                        <?php foreach ($searchResults as $row) : ?>
                            <tr>
                                ...
                                <td><?php echo "<span style='color: yellow; font-weight: bold;'>Pending</span>"; ?></td>
                                <td>
                                  <div class="actionBtn">
                                    <form method="POST" action="updateRemarks.php">
                                        <input type="hidden" name="id" value="<?php echo $row['borrow_id']; ?>">
                                        <button type="submit" name="status" value="Active">Accept</button>
            ...
            <!-- Main Table -->
            <h2 id="mainTable">All Borrow Requests</h2>
            <table border="1" cellspacing="0" cellpadding="5">
                <thead>
                    <tr>
                        <th>Book Image</th>
